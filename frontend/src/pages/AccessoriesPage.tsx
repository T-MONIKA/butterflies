...
const adaptProductForCard = (apiProduct: ApiProduct): Product => ({
  ...
  type: (apiProduct.type as Product['type']) || 'other',
...
const AccessoriesPage: React.FC = () => {
  ...
  const fetchAccessoriesProducts = useCallback(async () => {
    ...
    try {
      ...
      setError('Failed to load accessories collection. Please try again.');
    } finally {
      setLoading(false);
    }
  }, [sortBy]);
      ...
      <div className="bg-white border-b">
        <div className="container-custom py-10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-4xl font-serif font-light text-gray-900 mb-2">Accessories Collection</h1>
              <p className="text-gray-600">Complete the look with curated accessories and finishing pieces.</p>
            </div>
      ...
      <div className="container-custom py-10">
        ...
        {!loading && !error && products.length === 0 && (
          <div className="text-center py-16 bg-white rounded-lg border border-gray-200">
            <p className="text-gray-600 mb-4">No products found in accessories collection.</p>
            <Link
              to="/shop"
